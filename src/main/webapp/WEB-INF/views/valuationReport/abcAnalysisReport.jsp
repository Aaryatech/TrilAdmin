			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="box" id="todayslist">
						<div class="box-title">
							<h3>
								<i class="fa fa-table"></i>ABC Analysis Report
							</h3>
							<div class="box-tool">
						 ...
						 <form id="submitPurchaseOrder" action="${pageContext.request.contextPath}/abcAnalysisReport" method="get">
						...
						<input id="typeId"  value="${typeId}"  name="typeId" type="hidden"  >
									</div>
					...
					<div class="table-responsive" style="border: 0" id="tbl">
						<table class="table table-advance" id="table1">  
								...
								<c:choose>
												 	<c:when test="${ categoryWiseReport.approvedQtyValue>0 or categoryWiseReport.issueQtyValue>0 or categoryWiseReport.opStockValue>0 }">
											<tr>
												...
												<td class="col-md-2" align="right"><fmt:formatNumber type = "number"  maxFractionDigits = "2" minFractionDigits="2" value ="${categoryWiseReport.opStockValue}"/> </td> 
											 
											<td class="col-md-2" align="right"><fmt:formatNumber type = "number"  maxFractionDigits = "2" minFractionDigits="2" value ="${categoryWiseReport.approvedQtyValue}"/> </td> 
...
function showChart(){
	...
	function exportToExcel()
	{
	  ...
	  function getDetailReport(id,catDesc) {
		 var typeName = $("#typeId option:selected").text();
		//alert(catDesc);
		 location.href='${pageContext.request.contextPath}/abcAnalysisItemWiseReport/'
				+ id +''+catDesc; 
