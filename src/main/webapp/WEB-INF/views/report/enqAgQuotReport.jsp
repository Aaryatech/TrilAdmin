...
<body>
	...
	<c:url var="getItemEnqAgReportBetDAte"
		value="/getItemEnqAgReportBetDAte"></c:url>
			...
			<div class="page-title">
				<div>
					<h1>
						...
						<i class="fa fa-file-o"></i>Item Enquiry Against Quotation/Indent
					</h1>
				</div>
			</div>
			<!-- END Page Title -->
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="box" id="todayslist">
						<div class="box-title">
							<h3>
								<i class="fa fa-table"></i>Item Enquiry Against Quotation/Indent
							</h3>
						...
						<div class="box-content">
							...
							<div class="box-content">
								...
								<div class="col-md-3">
									<select class="form-control chosen" name="vendorIdList"
										id="vendorIdList" multiple="multiple">
	...
	<script type="text/javascript">
		function search() {
			...
			$.getJSON('${getItemEnqAgReportBetDAte}',

			{
				...
				vendorIdList : JSON.stringify(vendorIdList),
				status : status,
				ajax : 'true'
