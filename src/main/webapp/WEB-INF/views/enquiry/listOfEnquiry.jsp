						...
						<div class="box-title">
							...
							<div class="box-tool">
								<a href="${pageContext.request.contextPath}/addEnquiry">
									Add Enquiry</a> <a data-action="collapse" href="#"><i
					...
					<div class="table-responsive" style="border: 0">
						<table class="table table-advance" id="table1">  
									...
									<tr class="bgpink">
										...
										<th class="col-md-1">Intent No</th> 
										...
										<tr>
											...
											<td><a
												href="${pageContext.request.contextPath}/editEnquiry/${enquiryList.enqId}"><abbr
													...
													<a href="${pageContext.request.contextPath}/deleteEnquiry/${enquiryList.enqId}" onClick="return confirm('Are you sure want to delete this record');"><span
						  ...
						  $.each(
										...
										function(key, itemList) {
											...
											var tr = $('<tr></tr>'); 
										  	...
										  	tr.append($('<td></td>').html(itemList.enqDate));
										  	tr.append($('<td></td>').html(itemList.vendorName));  
										  	tr.append($('<td></td>').html(itemList.enqNo));
										  	tr.append($('<td></td>').html(itemList.indNo));
										  	tr.append($('<td></td>').html('  <a href="javascript:genPdf('+itemList.enqId+');"><abbr'+
													...
													'title="Edit"><i class="fa fa-edit"></i></abbr></a> <a href="${pageContext.request.contextPath}/deleteEnquiry/'+itemList.enqId+'"'+
...
<script type="text/javascript">
			function genPdf(id) {
				...
				window.open('pdfForReport?url=showEditViewIndentDetail/'
						+ id );
