						...
						<div class="box-content">
							<form method="post" class="form-horizontal"
								...
								<div class="form-group">
									...
									<label class="col-sm-3 col-lg-2 control-label">Select Vendor 
										</label>
									<div class="col-sm-6 col-lg-4 controls">
								...
								<div class="form-group">
									...
									<label class="col-sm-3 col-lg-2 control-label">GRN No
										</label>
									<div class="col-sm-6 col-lg-4 controls">
								...
								<div class="form-group" >
									<label class="col-sm-3 col-lg-2 control-label">Gate Entry No
									</label>
									...
									<label class="col-sm-3 col-lg-2 control-label">Gate Entry Date
										</label>
									<div class="col-sm-6 col-lg-4 controls">
								...
								<div class="form-group" >
									<label class="col-sm-3 col-lg-2 control-label">Chalan No
									</label>
									...
									<label class="col-sm-3 col-lg-2 control-label">Chalan Date
										</label>
									<div class="col-sm-6 col-lg-4 controls">
								...
								<div class="form-group" >
									...
									<label class="col-sm-3 col-lg-2 control-label">Bill Date
										</label>
									<div class="col-sm-6 col-lg-4 controls">
							...
							<section></section>
								<div class="form-group">
									<label class="col-sm-3 col-lg-2 control-label">Select from PO List </label>
									<div class="col-sm-6 col-lg-4 controls">

										<select name="po_list" id="po_list" class="form-control chosen"
											placeholder="Group" data-rule-required="true" multiple="multiple">
										</select>
									</div>
									
									<label class="col-sm-3 col-lg-2 control-label">PO Detail
										</label>
									<div class="col-sm-6 col-lg-4 controls">
										<input class="btn btn-large" id="getPoButton" onclick="getPoDetail()"
											size="16" type="button" name="getPoButton" value="PO Detail"
											 />
									</div>
            ...
            function() {
				...
				// $("#items").append($("<option></option>").attr( "value",-1).text("ALL"));
                    for ( var i = 0; i < len; i++) {
                        ...
                        $("#po_list").append(
                                $("<option></option>").attr(
                                    "value", data[i].poId).text(data[i].poNo)
                            );
                    }
