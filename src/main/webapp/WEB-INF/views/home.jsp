...
<body>
	...
	<c:url var="exportToExcelForStoreDash"
		value="/exportToExcelForStoreDash"></c:url>
	<!-- BEGIN Container -->
												...
												<c:choose>
													<c:when test="${flag==0}">
														...
														<input type="button" class="btn btn-primary" value="PDF"
															id="PDFButton" onclick="genPdf(${categoryList.catId})"
															value="PDF">
														<input type="button" id="expExcel" class="btn btn-primary"
															value="EXPORT TO Excel"
															onclick="exportToExcel(${categoryList.catId});">
													</c:when>
													<c:when test="${flag==1}">
														<input type="submit" class="btn btn-info" value="Submit">
					...
					<div class="box">
						<div class="box-content">
							<div class="row">
								...
								<div class="col-md-2">${indentList.accountHead}</div>
...
function myFunction() {
  ...
  for (i = 0; i < tr.length; i++) {
	...
	<script type="text/javascript">
		function genPdf(catId) {
			/* alert("hiii"); */
			/*var catId = document.getElementById("catId").value; */

			window
					.open('${pageContext.request.contextPath}/showStoreDashBoardPdf/'
							+ catId);
	...
	<script type="text/javascript">
		function exportToExcel(catId) {
			
			$.getJSON('${exportToExcelForStoreDash}',
                    {
			                catId : catId,
