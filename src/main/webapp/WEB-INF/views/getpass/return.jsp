											...
											<c:forEach items="${getpassDetailItemName}"
												...
												<tr>
													...
													<td class="col-md-2"><c:out
															value="${getpassDetailItemName.gpQty}" /></td>

													<td class="col-md-2"><c:out
															value="${getpassDetailItemName.gpRemQty}" /></td>

													<td class="col-md-2"><c:out
															value="${getpassDetailItemName.gpRetQty}" /></td>
													...
													<td><a
														href="${pageContext.request.contextPath}/editGetpassHeaderRet/${getpassDetailItemName.gpId}"><abbr
															title="Edit"><i class="fa fa-edit"></i></abbr></a> <a
														href="${pageContext.request.contextPath}/deleteGetpassHeaderReturnable/${getpassDetailItemName.gpId}"
