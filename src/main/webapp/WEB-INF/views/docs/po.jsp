...
<body>
	...
	<c:forEach items="${list}" var="item" varStatus="count">
		...
		<table width="100%">
			<tr>
				...
				<td width="60%" style="text-align: center;" align="center">
					...
					<h6 style="font-weight: bold; margin: 0px;" align="center">(Formally
		...
		<table align="center" border="1" cellpadding="0" cellspacing="0"
			...
			<tbody>
				...
				<tr style="font-size: 13px;">
					...
					<td align="left" width=50% style="padding: 5px;"><c:out
		...
		<p style="font-weight: normal; margin: 0px; padding-bottom: 10px"
			align="right">
			${pageCount}/
			<fmt:formatNumber value="${totalPage+(1-(totalPage%1))%1}"
				type="number" pattern="#" />
			<c:set var="pageCount" value="${pageCount+1}" />
		</p>
		<!-- END Main Content -->
