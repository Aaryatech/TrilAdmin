			...
			<div class="sidebarright">
				...
				enctype="multipart/form-data"> 
						...
						<div class="col-md -3">
								...
								<div class="col1title" align="left"><h3>Add Tax Form</h3></div>
					...
					<div class="colOuter">
						...
						<div class="col-md-3">
							<input id="taxDesc" class="form-control"
								placeholder="Tax Description"   style="text-align: left;" name="taxDesc" type="text" required>
						...
						<div class="col-md-3">
							<input id="taxPer" class="form-control"
								placeholder="Tax Percentage"   style="text-align: left;" name="taxPer" type="text" required>
