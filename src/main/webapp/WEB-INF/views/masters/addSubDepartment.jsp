			...
			<div class="sidebarright">
				...
				enctype="multipart/form-data"> 
						...
						<div class="col-md -3">
								...
								<div class="col1title" align="left"><h3>Add Sub Department</h3></div>
					...
					<div class="colOuter">
						...
						<div class="col-md-2">
							<div class="col1title" align="left"> Department Description*: </div>
						</div>
						<div class="col-md-3">
					...
					<div class="col-md-2">
							<div class="col1title" align="left">Sub Department Code*: </div>
						</div>
						<div class="col-md-3">
					...
					<div class="col-md-2">
							<div class="col1title" align="left">Select Department*: </div>
						</div>
