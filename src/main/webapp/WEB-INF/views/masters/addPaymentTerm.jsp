			...
			<div class="wrapperIn2">
				...
				<div class="sidebarright">
					...
					<form name="frm_search" id="frm_search" method="post"
						...
						<div class="colOuter">
							<div class="col-md-2">
								<div class="col1title" align="left">Payment Description*:
								</div>
							</div>
							<div class="col-md-3">
										...
										<c:forEach items="${paymentTermsList}" var="paymentTermsList"
											...
											<tr>
												...
												<td><a
													...
													<a
													href="${pageContext.request.contextPath}/deletePaymentTerm/${paymentTermsList.pymtTermId}"><abbr
