			...
			<div class="sidebarright">
				...
				enctype="multipart/form-data"> 
						...
						<div class="col-md -3">
								...
								<div class="col1title" align="left"><h3>Add Payment Discription</h3></div>
								 
						</div>
						
					<div class="colOuter">
						<div class="col-md-2">
							<div class="col1title" align="left">Payment Discription*: </div>
						</div>
						<div class="col-md-3">
							<input id="payDesc" class="form-control"
								placeholder="Payment Term Description"   style="text-align: left;" name="payDesc" type="text" required>
										...
										<table id="table_grid1" class="main-table small-td">
											<thead>
												<tr class="bgpink">
													...
													<th class="col-md-1">Payment Discription</th>   
