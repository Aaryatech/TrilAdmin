			...
			<div class="sidebarright">
				...
				enctype="multipart/form-data"> 
						...
						<div class="col-md -3">
								...
								<div class="col1title" align="left"><h3>Add Item Sub Group</h3></div>
					...
					<div class="colOuter">
						...
						<div class="col-md-2">
							<div class="col1title" align="left">Sub Group Description*: </div>
						</div>
						<div class="col-md-3">
							<input id="subGroupDesc" class="form-control"
								placeholder="Sub Group Description"   style="text-align: left;" name="subGroupDesc" type="text" required>
										...
										<table id="table_grid1" class="main-table small-td">
											<thead>
												<tr class="bgpink">
													...
													<th class="col-md-1">Sub Group Discription</th>  
