	...
	<div class="fullGrid center">
		...
		<div class="wrapperIn2">
			...
			<div class="sidebarright">
				...
				<form name="frm_search" id="frm_search" method="post" action="${pageContext.request.contextPath}/insertDeliveryTerm"
				 > 
					 
						<div class="col-md -3">
							
								<div class="col1title" align="left"><h3>Add Delivery Term</h3></div>
								 
						</div>
						
					<div class="colOuter">
						<div class="col-md-2">
							<div class="col1title" align="left">Delivery Term Description*: </div>
						</div>
						<div class="col-md-3">
					...
					<div class="colOuter">
					  ...
					  <div id="table-scroll" class="table-scroll">
									...
									<tr>
									 ...
									 <a href="${pageContext.request.contextPath}/deleteDeliveryTerms/${deliveryTermsList.deliveryTermId}"><abbr title="Delete"><i onclick="del('+key+')" class="fa fa-trash"></i></abbr></a>
