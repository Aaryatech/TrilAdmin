...
<body>
					...
					<div class="box">
						...
						<div class="box-content">
							<form method="post" class="form-horizontal" id="validation-form">
								...
								<input type="hidden" name="limitEnabled" id="limitEnabled"
									value="1" />
								...
								<div class="box-content">
									...
									<div class="col-md-3">
										<input type="hidden" name="typeId" id="typeId" value="0" /> <select
											name="indent_type" onchange="getInvoiceNo()" id="indent_type"
									...
									<div class="col-md-3">
										<input type="hidden" name="catId" id="catId" value="0" /> <select
											id="ind_cat" name="ind_cat" class="form-control chosen"
											placeholder="Indent Category" onchange="getInvoiceNo()"
											data-rule-required="true">
								...
								<div class="box-content">
									...
									<div class="col-md-3">
										<input class="form-control date-picker" id="indent_date"
											onblur="getInvoiceNo()" size="16" type="text"
											name="indent_date" value="${date}" required
											data-rule-required="true" />
									</div>
								...
								<div class="box-content">
									...
									<div class="col-md-10">
										<input type="text" name="indHeaderRemark" id="indHeaderRemark"
											placeholder="Remark" class="form-control" value="-" required />
									</div>
								</div>
								<br> <br>
								<div class="box-content">
									...
									<div class="col-md-3">
										<select name="acc_head" id="acc_head"
											...
											<c:forEach items="${accountHeadList}" var="accHead"
												varStatus="count">
												<option value="${accHead.accHeadId}"><c:out
														value="${accHead.accHeadDesc}" /></option>
											</c:forEach>
										</select>
									</div>
									<div class="col-md-1"></div>
									<!-- <label class="col-md-2">Machine
										Specific</label> -->
									<input id="machine_specific" type="hidden"
										name="machine_specific" value="1" />
								...
								<div class="box-content">
									<label class="col-md-2">For Development </label>
									...
									<div class="col-md-1"></div>
									<label class="col-md-2">For Monthly </label>
									<div class="col-md-3">
									...
									<div class="col-md-3">
										<select name="dept" id="dept" class="form-control chosen"
											...
											<c:forEach items="${deparmentList}" var="dept"
												varStatus="count">
												<option value="${dept.deptId}">${dept.deptCode}
													&nbsp;&nbsp; ${dept.deptDesc}</option>
											</c:forEach>
										</select>
									</div>
									<div class="col-md-1"></div>
								...
								<div class="box-content">
									...
									<div class="col-md-2"
										style="font-weight: bold; font-size: 15px;" id="mrnLimit">
									</div>
									<input type="hidden" name="mrnLimitText" id="mrnLimitText" />

									<div class="col-md-2">Total MRN :</div>
									<div class="col-md-2"
										style="font-weight: bold; font-size: 15px;" id="totalmrn">

									</div>
									<input type="hidden" name="totalmrnText" id="totalmrnText" />


									<div class="col-md-2">Approved Indent Value :</div>

									<div class="col-md-2"
										style="font-weight: bold; font-size: 15px;"
										id="approvedIndentValue"></div>

									<input type="hidden" name="approvedIndentValueText"
										id="approvedIndentValueText" />
								</div>
								<div class="box-content">
									...
									<div class="col-md-2">Total Indent Value :</div>

									<div class="col-md-2"
										style="font-weight: bold; font-size: 15px;"
										id="totalIndentValue"></div>
									<input type="hidden" name="totalIndentValueText"
										id="totalIndentValueText" />

									<div class="col-md-2">Non-Approved Indent Value :</div>

									<div class="col-md-2"
										style="font-weight: bold; font-size: 15px;"
										id="totalIndentPendingValue"></div>
									<input type="hidden" name="totalIndentPendingValueText"
										id="totalIndentPendingValueText" />
								</div>
								<br> <br> <span
									style="text-align: left; font-weight: bold; font-size: 20px;">Add
									Item</span>
								...
								<div class="box-content">
									...
									<label class="col-md-2">Schedule Days</label>
								...
								<div class="row">
									<div class="col-md-12" style="text-align: center">
										<input type="button" onclick="insertIndentDetail()"
											class="btn btn-info" value="Submit" id="addItemBtn">
										<input type="hidden" id="indentItemLimitValue"
											name="indentItemLimitValue" value="${indentItemLimit.value}">
										<c:choose>
										...
										<br> <span style="color: red; display: none;"
											id="error_itemnotadd">Your can't Add this Item. MRN is
											not Completed till now of this Item.</span>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12" style="text-align: center">
										...
										<input type="button" onclick="insertIndent()" id="submitt"
	...
	<script type="text/javascript">
		function checkItemPosition( ) {
			...
			var indentItemLimitValue = $("#indentItemLimitValue").val();
			
			if (indentItemLimitValue == 1) {
														...
														.getJSON(
																...
																function(data) {
																	...
																	$(
																			...
																			.remove()
																			.end()
																 $("#item_name").append($("<option></option>").attr( "value","").text("select Item"));
																	for (var i = 0; i < len; i++) {
	...
	<script type="text/javascript">
		function insertIndentDetail() {
			...
			var currentTotalIndentValue = parseFloat(document
					.getElementById("totalIndentValueText").value);
												...
												$
														.each(
																...
																function(key,
																	...
																	document
																			.getElementById("typeId").value = typeId;
																	document
					...
					.getJSON(
							...
							function(data) {
								...
								if (data == "") {
									...
									$('#indent_type').prop('disabled', false)
											.trigger("chosen:updated");
	...
	<script type="text/javascript">
			...
			$
					.getJSON(
							...
							function(data) {
								...
								document.getElementById("mrnLimit").innerHTML = (parseFloat(data.subDocument.categoryPostfix))
										.toFixed(2);
								document.getElementById("mrnLimitText").value = (parseFloat(data.subDocument.categoryPostfix))
										.toFixed(2);
									...
									if (data[i].typeId == typeId) {
										...
										for (var j = 0; j < data[i].consumptionReportList.length; j++) {
											...
											if (data[i].consumptionReportList[j].catId == catId) {
												...
												document
														.getElementById("totalmrn").innerHTML = (parseFloat(data[i].consumptionReportList[j].monthlyValue))
														.toFixed(2);
												document
														.getElementById("totalmrnText").value = (parseFloat(data[i].consumptionReportList[j].monthlyValue))
														.toFixed(2);
												flag = 1;
												break;
											}
			...
			$
					.getJSON(
							...
							function(data) {
								...
								document.getElementById("approvedIndentValue").innerHTML = (parseFloat(data))
										.toFixed(2);
								document
										.getElementById("approvedIndentValueText").value = (parseFloat(data))
										.toFixed(2);
			...
			$
					.getJSON(
							...
							function(data) {
								...
								document
										.getElementById("totalIndentPendingValue").innerHTML = (parseFloat(data))
										.toFixed(2);
								document
										.getElementById("totalIndentPendingValueText").value = (parseFloat(data))
										.toFixed(2);

								var approvedIndentValueText = parseFloat($(
										"#approvedIndentValueText").val());

								document.getElementById("totalIndentValue").innerHTML = (parseFloat(approvedIndentValueText
										+ data)).toFixed(2);
								document.getElementById("totalIndentValueText").value = (parseFloat(approvedIndentValueText
										+ data)).toFixed(2);
							});
		...
		function getLastRate(qty, flag) {
			...
			var itemId = $("#item_name").val();
			var totalIndentValueText = parseFloat($("#totalIndentValueText")
					.val());
			$
					.getJSON(
							'${getLastRate}',
							...
							function(data) {
								...
								document.getElementById("totalIndentValue").innerHTML = (parseFloat(data))
										.toFixed(2);
								document.getElementById("totalIndentValueText").value = (parseFloat(data))
										.toFixed(2);
