...
public class IndentStatusPendingReport {
	...
	public String toString() {
		return "IndentStatusPendingReport [sr=" + sr + ", indDId=" + indDId + ", indMNo=" + indMNo + ", indMDate="
				+ indMDate + ", itemId=" + itemId + ", itemCode=" + itemCode + ", indItemSchddt=" + indItemSchddt
				+ ", remark=" + remark + ", excessDays=" + excessDays + ", indQty=" + indQty + ", rate=" + rate
				+ ", balQty=" + balQty + "]";
	}
